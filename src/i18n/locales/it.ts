...
export const dictionary: Dict = {
  ...
  about: {
    ...
    founderEyebrow: "Fondatrice", founderName: "Natalia Kozhushko",
    founderBio1: "Mi occupo di organizzare matrimoni in Italia per coppie internazionali, con un approccio profondamente personale a ogni celebrazione e alle persone che la rendono possibile.",
    founderBio2: "L'Alto Adige è la mia casa da quasi vent'anni, e le Dolomiti sono la regione che conosco più a fondo. Lingue, viaggi e culture diverse sono sempre stati parte della mia vita, come la naturale inclinazione a riunire le persone e creare eventi significativi.",
    founderBio3: "Amo la complessità dell'organizzazione di un matrimonio quanto il suo lato creativo. Gli anni di esperienza mi hanno anche insegnato che il team giusto non è mai lo stesso per ogni matrimonio — sapere quali location, creativi e partner si adattano davvero a ogni coppia è parte essenziale del mio lavoro.",
    founderBio4: "Soprattutto, apprezzo la fiducia di essere scelta per assumermi la responsabilità di un momento così importante.",
  ...
  portfolio: {
    ...
    stories: [
      ...
      { place: "In definizione", couple: "MyHuyen & Eric", year: "2026", desc: "Celebrazione in montagna il 28 giugno — ritratti di coppia, cerimonia, cocktail, cena e scambio regali cinesi. Racconto completo in arrivo." },
    ],
