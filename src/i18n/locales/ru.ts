...
export const dictionary: Dict = {
  ...
  home: {
    ...
    instagramEyebrow: "В Instagram", instagramTitle: "Свежие кадры @italian.wedding.magic", instagramViewPhoto: "Открыть фото в галерее",
  },
  about: {
    eyebrow: "Студия", h1a: "Маленькая студия", h1b: "с долгой памятью Италии.",
    founderEyebrow: "Основательница", founderName: "Наталия Козушко",
    founderBio1: "Я специализируюсь на организации свадеб в Италии для международных пар — с максимально личным подходом к каждому празднику и людям, которые за ним стоят.",
    founderBio2: "Южный Тироль — мой дом уже почти двадцать лет, а Доломиты — регион, который я знаю лучше всего. Языки, путешествия и разные культуры всегда были частью моей жизни, как и естественная склонность объединять людей и создавать значимые события.",
    founderBio3: "Мне нравится сложность организации свадеб не меньше, чем её творческая сторона. Годы опыта также научили меня, что правильная команда никогда не одинакова для каждой свадьбы — знать, какие площадки, креативщики и партнёры действительно подойдут каждой паре, — важная часть моей работы.",
    founderBio4: "Прежде всего я ценю доверие, с которым ко мне обращаются, поручая ответственность за такой важный момент.",
  ...
  portfolio: {
    ...
    stories: [
      ...
      { place: "Уточняется", couple: "MyHuyen & Eric", year: "2026", desc: "Празднование в горах 28 июня — портреты пары, церемония, коктейль, ужин и китайский обмен подарками. Полный текст скоро." },
    ],
