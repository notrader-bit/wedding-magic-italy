...
export const dictionary: Dict = {
  ...
  home: {
    ...
    instagramEyebrow: "En Instagram", instagramTitle: "Lo último de @italian.wedding.magic", instagramViewPhoto: "Ver foto en la galería",
  },
  about: {
    eyebrow: "El Estudio", h1a: "Un estudio pequeño", h1b: "con larga memoria de Italia.",
    founderEyebrow: "Fundadora", founderName: "Natalia Kozhushko",
    founderBio1: "Me especializo en planificar bodas en Italia para parejas internacionales, con un enfoque profundamente personal en cada celebración y en las personas que la hacen posible.",
    founderBio2: "El Tirol del Sur es mi hogar desde hace casi veinte años, y los Dolomitas son la región que conozco con mayor intimidad. Los idiomas, los viajes y las distintas culturas siempre han formado parte de mi vida, al igual que la afición natural por reunir a las personas y crear eventos con significado.",
    founderBio3: "Disfruto de la complejidad de la planificación de bodas tanto como de su lado creativo. Los años de experiencia también me han enseñado que el equipo adecuado nunca es el mismo para cada boda — saber qué espacios, creativos y socios encajan de verdad con cada pareja es una parte esencial de mi trabajo.",
    founderBio4: "Sobre todo, valoro la confianza de ser elegida para asumir la responsabilidad de un momento tan importante.",
  ...
  portfolio: {
    ...
    stories: [
      ...
      { place: "Por confirmar", couple: "MyHuyen & Eric", year: "2026", desc: "Celebración en la montaña el 28 de junio — retratos, ceremonia, cóctel, cena e intercambio de regalos chinos. Historia completa próximamente." },
    ],
