...
export const dictionary: Dict = {
  ...
  home: {
    ...
    instagramEyebrow: "В Instagram", instagramTitle: "Останні кадри з @italian.wedding.magic", instagramViewPhoto: "Переглянути фото в галереї",
  },
  about: {
    eyebrow: "Студія", h1a: "Маленька студія", h1b: "з довгою пам'яттю Італії.",
    founderEyebrow: "Засновниця", founderName: "Наталія Козушко",
    founderBio1: "Я спеціалізуюся на організації весіль в Італії для міжнародних пар — з максимально особистим підходом до кожного свята та людей, які за ним стоять.",
    founderBio2: "Південний Тіроль — мій дім уже майже двадцять років, а Доломіти — регіон, який я знаю найглибше. Мови, подорожі та різні культури завжди були частиною мого життя, як і природна схильність об'єднувати людей і створювати значущі події.",
    founderBio3: "Мені подобається складність організації весіль не менше, ніж її творча сторона. Роки досвіду також навчили мене, що правильна команда ніколи не однакова для кожного весілля — знати, які майданчики, креативники та партнери справді підійдуть кожній парі, — важлива частина моєї роботи.",
    founderBio4: "Насамперед я ціную довіру, з якою до мене звертаються, доручаючи відповідальність за такий важливий момент.",
  ...
  portfolio: {
    ...
    stories: [
      ...
      { place: "Уточнюється", couple: "MyHuyen & Eric", year: "2026", desc: "Святкування в горах 28 червня — портрети пари, церемонія, коктейль, вечеря та китайський обмін подарунками. Повний текст незабаром." },
    ],
